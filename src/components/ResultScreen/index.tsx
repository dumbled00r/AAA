...
import { AppLogo, Refresh, StartIcon } from '../../config/icons'
...
const ResultScreen: FC = () => {
  ...
  const onClickRetry = () => {
    // Show an image at /src/assets/images/Date.png
    window.location.href = 'https://forms.gle/3i3hq3nxwotc2TnK9'
  }
  ...
  return (
    <ResultScreenContainer>
      ...
      <Flex flxEnd>
        {/* <Link to="https://forms.gle/3i3hq3nxwotc2TnK9"> */}
        <Button
          text="Tiếp tục"
