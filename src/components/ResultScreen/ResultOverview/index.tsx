...
const ResultOverview: FC<ResultOverviewProps> = ({ result }) => {
  ...
  const calculateStatus =
    (obtainedScore / quizDetails.totalScore) * 100 >= 40 ? 'Đạt' : 'Trượt!!!'
  ...
  return (
    <ResultOverviewStyle>
      ...
      <p>
        Điểm:<HighlightedText> {obtainedScore} </HighlightedText>/{' '}
      ...
      <p>
        Trạng thái:<HighlightedText> {calculateStatus}</HighlightedText>
      </p>
    </ResultOverviewStyle>
  )
}
